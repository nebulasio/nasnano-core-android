...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d("Neo Wallet", wallet.getAddress());

            NebAccount account = new NebAccount();
            Log.d("Nas Wallet", account.getAddress());

        } catch (Exception e) {
            e.printStackTrace();
        }
        btnGo.setOnClickListener(view -> AddressKeystoreTest());
    }

    private void AddressKeystoreTest() {
        NebAccount account = null;
        try {
            account = new NebAccount("5876489b63d456e3c82b043d235b46f76d4503b613230ed47d10bc4921e22f6a");
